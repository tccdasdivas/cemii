    ...
    <View style={{ flex: 1, backgroundColor: '#faf8d4' }}>
          ...
          <View style={styles.box1}>
            ...
            <View style={{ flexDirection: 'row', alignItems: 'center', marginTop: 20, marginLeft: -10 }}>
              ...
              <View style={{ alignItems: 'center', marginLeft: 35 }}>
                <Text style={styles.texto1}> {user?.nome ? user.nome : "Usuário"}</Text>
                <Text style={styles.texto2}> {user?.profissao ? user.profissao : "Usuário"}</Text>
              </View>
            </View>
          </View>
      ...
      <View style={{
        ...
        <TouchableOpacity onPress={enviarMensagem} style={{ 
          marginLeft: 10, 
          backgroundColor: 'rgba(127, 169, 199,0.6)', borderRadius: 50, 
